...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <h2 style="margin:0px 300PX;"class="title">THỰC HÀNH KHAI BÁO BẰNG MÁY TRỰC PO</h2>
            </div> --}}



            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg"
                style="width:100%; margin:0;padding:0px 0; text-align:center;">
                <div class="grid grid-cols-1 md:grid-cols-1" style="padding:0px;">
                    ...
                    <div>
                        <div style="width:50%; float:left;">
                            ...
                            <h4 style="margin-bottom:0px; margin-top:0px;">Click vào PO1 : <span
                                    id="tong-dai-1-text">{{ $thuebao_1->sodienthoai }}</span> để thực hành khai báo </h4>
                            <div id="po-output-wrap">
                                <br />
                                <div>
                                    <div class="anh-tong-dai-po"
                                        style="background:#fff;width:100%;height:auto;margin:-20px auto 0; position: relative;overflow:hidden;">
                                        <img src="/storage/images/anh-tong-dai-PO1.jpg" class="img img-100" />
                                ...
                                <div class="phone-list phone-list-td-1">
                                    {{-- <div class="phone-item">
                                        <a href="javascript:void(0)" id="td-1-phone-2"
                                            data-phone-number="{{ $thuebao_2->sodienthoai }}" data-phone-td="1"
                                            data-phone-stt="2">
                                    ...
                                    {{-- <div class="phone-item">
                                        <a href="javascript:void(0)" id="td-1-phone-3"
                                            data-phone-number="{{ $thuebao_3->sodienthoai }}" data-phone-td="1"
                                            data-phone-stt="3">
                                            <img src="/storage/images/phone.png" class="img img-100" />
                                    ...
                                    <div class="phone-item">
                                        <a href="javascript:void(0)" id="td-1-phone-po"
                                        data-phone-number="{{ $thuebao_1->sodienthoai }}" data-phone-td="1"
                                        data-phone-stt="1" onclick="showIndicator(this);">
                                        <img src="/storage/images/phone.png" class="img img-100" />
                                        PO1: <span class="phone-number-text">{{ $thuebao_1->sodienthoai }}</span>
                                    </a>
                                        <span class="indicator"></span> <!-- Đèn báo -->
                                    </div>
                            ...
                            <div id="po-input-wrap" style="display: none;">
                                ...
                                <input type="text" id="po-input" name="po-input"
                                    style="width:200px;font-size:24px;border:1px solid #ccc;text-align:center;"
                                    placeholder="*60*01#" />
                            </div>
                        </div>
                        {{-- <div style="width:50%; float:left;">
                            ...
                            <div class="phone-list phone-list-td-2">
                                <div class="phone-item">
                                    <a href="javascript:void(0)" id="td-2-phone-po" data-phone-number="659100"
                                        data-phone-td="2" data-phone-stt="1">
                                        <img src="/storage/images/phone.png" class="img img-100" />
                    ...
                    <div class="keyboard-wrap">
                        <div class="btn-group-vertical ml-4 mt-4" id="keyboard">
                            ...
                            <div class="btn-group">
                                ...
                                <input class="text-center form-control-lg mb-2 keyboard-output" id="code"
                                    autocomplete="off">
                            </div>
                            <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-outline-secondary py-3"
                                    onclick="document.getElementById('code').value=document.getElementById('code').value + '*';">*</button>
                                <button type="button" class="btn btn-outline-secondary py-3"
                                    onclick="document.getElementById('code').value=document.getElementById('code').value + '0';">0</button>
                                <button type="button" class="btn btn-outline-secondary py-3" id="enter-cmd"
                                    onclick="document.getElementById('code').value=document.getElementById('code').value + '#';">#</button>
                            </div>
                            <div class="btn-group">
                                <button type="button" class="btn btn-outline-secondary py-3"
                                    onclick="document.getElementById('code').value=document.getElementById('code').value = '';">C</button>
                                <button type="button" class="btn btn-outline-secondary py-3"
                                    onclick="document.getElementById('code').value=document.getElementById('code').value.slice(0, -1);">&lt;</button>
                                <button type="button" class="btn btn-outline-secondary py-3"
                                    id="action-call">Go</button>
                            </div>

                            <div>
                                <p style="margin-bottom:0">CMD output: <span id="po-output-text"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function processCommand(cmd) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#code").val("");
                        console.log("#" + data.sound + "-sound");
                        $("#" + data.sound + "-sound")[0].play();
            ...
            $("#enter-cmd").click(function() {
                ...
                if (isValidCmd) {
                    if (tong_dai == 1 && stt == 1) {
                        ...
                        alert("Hàm gọi máy " + phone_number + " - Tổng đài " + tong_dai +
                            " không được phép khai báo");
                    }
                } else {
            ...
            // Xóa đèn báo sáng trên tất cả các mục thuê bao
            var indicators = document.querySelectorAll('.indicator');
            indicators.forEach(function(indicator) {
                indicator.classList.remove('active');
            });

            // Thêm đèn báo sáng cho mục thuê bao được nhấp
...
<audio id="success-sound" src="/storage/sounds/success_2.wav" preload="auto"></audio>
<audio id="error-sound" src="/storage/sounds/error_2.wav" preload="auto"></audio>
